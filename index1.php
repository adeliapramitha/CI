                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-notification">
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                                ...
                                <p>Pesanan telah diterima oleh "dia".</p>
                            </a>
                                <a class="dropdown-item media bg-flat-color-4" href="#">
                                <i class="fa fa-info"></i>
                                <p>Daftar Pesanan berhasil diperbarui.</p>
                            </a>
                                <a class="dropdown-item media bg-flat-color-5" href="#">
                                <i class="fa fa-warning"></i>
                                <p>Stok Vitamin menipis!</p>
                            </a>
                            </div>
                        </div>
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <span class="message media-body">
                                    ...
                                    <span class="time float-right">5 minutes ago</span>
                                        <p>I wanna order more medicine.</p>
                                </span>
                            </a>
                                <a class="dropdown-item media bg-flat-color-5" href="#">
                                ...
                                <span class="message media-body">
                                    ...
                                    <span class="time float-right">10 minutes ago</span>
                                        <p>The vitamin's has arrived, thank you!</p>
                                </span>
                            </a>
                                ...
                                <span class="message media-body">
                                    ...
                                    <span class="time float-right">15 minutes ago</span>
                                        <p>Can I buy medicine without an recipe?</p>
                                </span>
                            </a>
                            </div>
                        </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count">205037</span>
                        </h4>
                        <p class="text-light">Delivery</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-4">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count">5092874</span>
                        </h4>
                        <p class="text-light">Visits</p>
